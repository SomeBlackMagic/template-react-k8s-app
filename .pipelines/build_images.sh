...
build_base_image "BUILD node-dev" \
    "$DOCKER_SERVER_HOST:$DOCKER_SERVER_PORT/$DOCKER_PROJECT_PATH/node${DOCKER_NODE_VERSION}-dev:$DOCKER_IMAGE_VERSION" \
    ".docker/node${DOCKER_NODE_VERSION}-dev/"
